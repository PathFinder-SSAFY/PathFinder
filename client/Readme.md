...
건물입구에서 부터 각기다른 입구별로 배치되어 있는 각기다른 ID값을 가진 NFC태깅을 통해 어플리케이션을 실행하고 현재위치를 파악할 수 있습니다.<br>
이 현재위치를 통해서 건물입구에서 곧바로 원하는 목적지 까지 입력하면 해당 목적지까지 갈 수 있는 최적의 경로를 알려줍니다.<br>
